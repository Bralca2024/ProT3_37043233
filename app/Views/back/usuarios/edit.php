...
<section class="container register-section col-md-6 col-lg-5 padding-section px-3">
  ...
  <form method="post" action="<?php echo base_url('updateData/' . $dato['id_usuario']); ?>">
    ...
    <!-- Submit button -->
    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4">Editar cuenta</button>
    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-danger btn-block mb-4"><a class="text-white text-decoration-none" href="<?php echo base_url('/dashboard'); ?>">Cancelar</a></button>
  </form>
</section>